...
export default function LensCard({ lens, index, userLensType }) {
  ...
  return (
    <div
      ...
      className="flex-none w-96 bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 border border-slate-200/50 hover:border-blue-300/50 group transform hover:-translate-y-2 hover:scale-[1.02] rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 border border-slate-200/50 hover:border-blue-300/50"
      style={{
    ...
    >
      <div className="flex flex-col">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 h-48">
          ...
          {/* Discount Badge – shown when price is visible */}
          {priceVisible && (
            <div className="absolute top-3 left-3 transition-opacity duration-500 ease-in-out opacity-100">
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col justify-between mb-4 gap-3">
            ...
            {/* Price Section */}
            <div className="relative flex items-center justify-between bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-2xl border border-green-200/50 transition-all duration-300 ease-in-out cursor-pointer">
              {/* Price Block */}
              <div className="flex flex-col">
                {/* SRP */}
