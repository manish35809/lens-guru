...
const initialData = [
  {
    ...
    poster: 'https://images.unsplash.com/photo-1574258495973-f010dfbb5371?w=300&h=200&fit=crop',
    srp: 15000,
    specialPrice: 12000,
...
export default function Home() {
  ...
  const handleSave = () => {
    ...
    if (editingId) {
      setLenses((prev) => prev.map((lens) => (lens.id === editingId ? newLens : lens)));
    } else {
  ...
  const handleExport = () => {
    const blob = new Blob([JSON.stringify(lenses, null, 2)], { type: 'application/json' });
  ...
  const getLensTypeLabel = (value) => {
    return lensTypeOptions.find(option => option.value === value)?.label || value;
  };

  const getThicknessTypeLabel = (value) => {
    return thicknessTypeOptions.find(option => option.value === value)?.label || value;
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold text-slate-800 mb-2">Lens Manager</h1>
            <p className="text-slate-600">Manage your optical lens collection with ease</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-slate-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Lens Name</label>
                  <input
                    name="name"
                    value={form.name}
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Material Country</label>
                  <input
              ...
              {/* Pricing & Technical */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-slate-700 border-b border-slate-200 pb-2">Pricing & Technical</h3>
                
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">SRP (₹)</label>
                    <input
                      name="srp"
                      type="number"
                      value={form.srp}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Special Price (₹)</label>
                    <input
                      name="specialPrice"
                      type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Processing Time (days)</label>
                  <input
                    name="time"
                    type="number"
                    value={form.time}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Thickness Index</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Thickness Type</label>
                    <select
                      name="thickness.type"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Coating Warranty (months)</label>
                  <input
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-slate-700 border-b border-slate-200 pb-2">Power Range</h3>
                
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">RP Minus</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">RP Plus</label>
                    <input
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Max Cyl Minus</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Max Cyl Plus</label>
                    <input
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Max Cyl Cross</label>
                  <input
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Add Range Start</label>
                    <input
                      name="addRange.start"
                      type="number"
                      step="0.25"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Add Range End</label>
                    <input
                      name="addRange.end"
                      type="number"
                      step="0.25"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Photochromic Colors</label>
                  <input
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Frame Types</label>
                  <input
                    value={form.frameTypeRecommended.join(', ')}
                    onChange={(e) => handleArrayChange(e, 'frameTypeRecommended')}
                    className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                    placeholder="full-rim, half-rim (comma separated)"
                  />
                </div>
              </div>
            </div>
            ...
            {/* Features */}
            <div className="mt-8">
              <h3 className="text-lg font-semibold text-slate-700 border-b border-slate-200 pb-2 mb-4">Features</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {[
                  ...
                  <label key={field} className="flex items-center gap-3 p-3 border border-slate-200 rounded-lg hover:bg-slate-50 cursor-pointer transition-colors duration-200">
                    <input
                      type="checkbox"
                      name={field}
                      checked={form[field]}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {lenses.map((lens) => (
            ...
            >
              ...
              <div className="p-6">
                <div className="mb-4">
                  <h3 className="text-xl font-bold text-slate-800 mb-2">{lens.name}</h3>
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold text-slate-800">₹{lens.srp?.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-600">Special Price:</span>
                    <span className="font-semibold text-emerald-600">₹{lens.specialPrice?.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-medium text-slate-800">
                      {lens.thickness?.index} ({getThicknessTypeLabel(lens.thickness?.type)})
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-600">Warranty:</span>
                    <span className="text-sm font-medium text-slate-800">{lens.lensCoatingWarranty} months</span>
                  </div>
                </div>
