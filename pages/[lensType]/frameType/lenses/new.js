          ...
          <div className="flex-1">
            ...
            {!showFilters && (
              <div className="relative">
                ...
                <button
                  onClick={() => {
                    const container = document.getElementById("lens-carousel");
                    const cardWidth = 384 + 24; // card width (w-96 = 384px) + gap
                    container.scrollBy({
                      left: -cardWidth * 3,
                      behavior: "smooth",
                    });
                  }}
                  className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 backdrop-blur-sm hover:bg-white shadow-xl hover:shadow-2xl rounded-full p-3 border border-gray-200/50 hover:border-blue-300/50 transition-all duration-300 hover:scale-110 group -ml-6"
                ...
                <button
                  ...
                  className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 backdrop-blur-sm hover:bg-white shadow-xl hover:shadow-2xl rounded-full p-3 border border-gray-200/50 hover:border-blue-300/50 transition-all duration-300 hover:scale-110 group -mr-6"
                  style={{ filter: "drop-shadow(0 4px 20px rgba(0,0,0,0.1))" }}
                >
                  <svg
                    className="w-6 h-6 text-gray-600 group-hover:text-blue-600 transition-colors duration-200"
                ...
                <div
                  id="lens-carousel"
                  className="flex gap-6 overflow-x-hidden scrollbar-hide scroll-smooth px-8 py-10"
                  style={{
                    scrollbarWidth: "none",
                    msOverflowStyle: "none",
                    WebkitScrollbar: { display: "none" },
                    width: "100%",
                    maxWidth: "calc(3 * 384px + 2 * 24px + 64px)", // 3 cards + 2 gaps + padding
                  }}
                >
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex flex-col justify-between mb-4 gap-3">
                            ...
                            <div className="flex items-center justify-between bg-gradient-to-r from-green-50 to-emerald-50 p-3 rounded-2xl border border-green-200/50">
                              ...
                              <div className="text-xs text-green-700 font-bold bg-green-100 px-2 py-1 rounded-lg">
                                Save ₹
                                {(
                          ...
                          {/* Protection Features - Compact Grid */}
                          <div className="mb-4">
                            ...
                            <div className="grid grid-cols-3 gap-2">
                              {[
                                ...
                                return (
                                  <div
                                    key={feature.key}
                                    className="group relative flex flex-col items-center justify-center p-2 rounded-xl bg-white border border-gray-100 hover:border-gray-200 transition-all duration-300 cursor-help hover:shadow-md hover:scale-105 min-h-[70px]"
                                    onMouseEnter={() =>
                                  ...
                                  >
                                    {/* Icon Container */}
                                    <div
                                      className={`flex items-center justify-center w-8 h-8 rounded-xl mb-1 transition-all duration-300 group-hover:scale-110 bg-gradient-to-r ${feature.gradient} shadow-md`}
                                    >
                                    ...
                                    {/* Feature Label */}
                                    <span className="text-xs font-bold text-center leading-tight text-gray-700 group-hover:text-gray-900 transition-colors duration-300">
                                      {feature.label}
                                    </span>

                                    {/* Enhanced Tooltip */}
                                    {hoveredFeature === feature.key && (
                                      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900/95 backdrop-blur-sm text-white text-xs rounded-xl shadow-2xl z-20 w-48 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                ...
                {/* Add some CSS for smooth scrolling and animations */}
                <style jsx>{`
